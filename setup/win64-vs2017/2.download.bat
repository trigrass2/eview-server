...
echo mget  cmake.rar boost1.66.rar cppredis.rar cryptlib.rar exceptionreport.rar jsoncpp.rar libdes.rar libmodbus.rar pkce.rar pkcomm.rar pkcrashdump.rar sqlapi.rar >> _download.ftp
...
echo mget vcruntime140.rar tinyxml2.rar python2.7.rar mongoclient.rar pksock.rar libmysql.rar pkhisdb.rar pkmemdb.rar pkservermgr.rar pkcommunicate.rar pkcommforward.rar pkprocesscontroller.rar >> _download.ftp
