...
echo copy bin dir
xcopy ..\..\bin\mfc120.dll ..\..\repo\eview-server\bin\ /y
xcopy ..\..\bin\msvcp120.dll ..\..\repo\eview-server\bin\ /y
xcopy ..\..\bin\msvcr120.dll ..\..\repo\eview-server\bin\ /y
xcopy ..\..\bin\msvcr100.dll ..\..\repo\eview-server\bin\ /y
...
xcopy ..\..\bin\python27.dll ..\..\repo\eview-server\bin\ /y
...
xcopy ..\..\source\python\LogProcessStatus\* ..\..\repo\eview-server\bin\ /y
...
set CURRENT_DATETIME=%date:~0,4%-%date:~5,2%-%date:~8,2%-%time:~0,2%-%time:~3,2%
set RAR_FILENAME=eview-server-base-%CURRENT_DATETIME%.rar
...
set PDB_RAR_FILENAME=eview-server-pdb-%CURRENT_DATETIME%.rar
xcopy ..\..\bin\*.pdb ..\..\repo\pdb\ /ySI
..\rar a -ep1 ../../repo/%PDB_RAR_FILENAME%  ../../repo/pdb
copy ..\..\repo\%PDB_RAR_FILENAME% ..\..\repo\eview-server-pdb.rar /y
