...
public:
	...
	PKCOMM_API static int CopyDir(const char *szAbsSrcFilePath, const char *szAbsDsFilePath);

	//Copy File to other
	PKCOMM_API static int CopyAFile(const char *szAbsSrcFilePath, const char *szAbsDsFilePath);
...
public:
	...
	PKCOMM_API static int AnsiToUtf8(string &strAnsiIn, string &strAnsiUtf8);			// Ansi/GBK--->UTF8
	...
	PKCOMM_API static string PKCodingConv::Utf8ToAnsi(string &strUtf8In);
	PKCOMM_API static int Utf8ToAnsi(string &strUtf8In, string &strAnsiOut);			// UTF8--->Ansi/GBK
