...
int ftpclient::connect(const char* addr, short port)
{
	string buffer;
...
int ftpclient::PASV(char* addr, short& port)
{
	char    command[256] = {0};
	string  buffer;
...
int ftpclient::PORT(const char* addr, short port)
{
	char   command[256] = {0};
	char*  ptr = command;
...
int ftpclient::serversock(SOCKET& sock, const char* addr, short port)
{
...
int ftpclient::datasock(SOCKET& sock, const char* addr, short port)
{
	struct  sockaddr_in serveraddr = {0};
