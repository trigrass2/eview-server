...
public:
	...
	int RelayControlCmd2Node(const char *szCtrlCmd, Json::Value &root);
	...
	int LogControl2Event(const char *szUserName, CNodeTag *pDataTag, const char *szTagVal, const char *szTime);
 };
