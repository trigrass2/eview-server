...
public:
	...
	int	InitAction();
	//动作处理函数
    int	ExecuteAction(char *szActionId, char *szTagName, char *szTagValue, char *szActionParam3, char *szActionParam4, char* nPriority, char* szJsonEventParams, char *szResult, int nResultBufLen);
